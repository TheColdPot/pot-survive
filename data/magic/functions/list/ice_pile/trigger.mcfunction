...
execute at @e[tag=magic.icePile.locator,scores={magic.Time=150..}] run particle block ice ~ ~ ~ 0 0 0 0 20
execute at @e[tag=magic.icePile.locator,scores={magic.Time=150..}] run playsound block.snow.break player @a ~ ~ ~
kill @e[tag=magic.icePile.locator,scores={magic.Time=150..}]
...
execute as @e[tag=magic.icePile.frozenEntity,scores={magic.icePile.frozenTime=100..}] run function magic:list/ice_pile/unfreeze
