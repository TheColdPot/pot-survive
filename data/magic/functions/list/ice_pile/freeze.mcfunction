...
execute at @e[limit=1,sort=nearest,type=!#magic:decoration,type=!player] run summon block_display ~-.5 ~ ~-.5 {block_state:{Name:"ice"},transformation:{right_rotation:[1f,0f,0f,0f],left_rotation:[1f,0f,0f,0f],translation:[0f,0f,0f],scale:[1f,2f,1f]},Tags:[magic.icePile,magic.icePile.ice],brightness:{sky:15,block:15}}
