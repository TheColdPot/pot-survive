...
execute unless score @s[tag=magic.Casting] magic.Phase matches 85.. run scoreboard players add @s magic.Phase 1

execute if entity @s[tag=magic.Casting,scores={staff.rightClick=1..}] run scoreboard players reset @s magic.Cast

execute if score @s[tag=magic.Casting] magic.Cast matches 5.. run function magic:list/ice_pile/summon
...
execute if score @s[tag=magic.Casting] magic.Phase matches 51..60 run title @s subtitle [{"text":"● ● ● ● ●","color":"gray"}]
