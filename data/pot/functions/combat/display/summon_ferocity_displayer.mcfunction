...
data merge entity @s {billboard:"center",Tags:[damageDisplay],text:'[{"text":"","color":"dark_gray"},{"score":{"name":"@s","objective":"combat.displayDamage"}}]',shadow:1b,background:0,transformation:{right_rotation:[0f,0f,0f,1f],scale:[1.2f,1.2f,1.2f],left_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f]},see_through:1b}
# I hate naming!!!!
