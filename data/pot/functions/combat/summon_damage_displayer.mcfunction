...
data merge entity @s {billboard:"center",Tags:[damageDisplay],text:'[{"score":{"name":"@s","objective":"combat.displayDamage"},"color":"gray"}]',shadow:1b,background:0,transformation:{right_rotation:[0f,0f,0f,1f],scale:[1f,1f,1f],left_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f]},see_through:1b}
# I hate naming!!!!
