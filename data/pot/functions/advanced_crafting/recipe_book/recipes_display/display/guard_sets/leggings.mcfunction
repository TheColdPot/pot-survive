...
item replace block ~ ~ ~ container.2 with minecraft:iron_ingot 3
item modify block ~ ~ ~ container.2 pot:ui_frame
item replace block ~ ~ ~ container.3 with minecraft:iron_ingot 3
item modify block ~ ~ ~ container.3 pot:ui_frame
item replace block ~ ~ ~ container.4 with minecraft:iron_ingot 3
item modify block ~ ~ ~ container.4 pot:ui_frame
item replace block ~ ~ ~ container.11 with minecraft:iron_ingot 3
item modify block ~ ~ ~ container.11 pot:ui_frame
item replace block ~ ~ ~ container.12 with air
item replace block ~ ~ ~ container.13 with minecraft:iron_ingot 3
item modify block ~ ~ ~ container.13 pot:ui_frame
item replace block ~ ~ ~ container.20 with minecraft:iron_ingot 3
item modify block ~ ~ ~ container.20 pot:ui_frame
item replace block ~ ~ ~ container.21 with air
item replace block ~ ~ ~ container.22 with minecraft:iron_ingot 3
item modify block ~ ~ ~ container.22 pot:ui_frame
loot replace block ~ ~ ~ container.15 loot pot:armor/guard/leggings
