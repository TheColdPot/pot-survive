...
item replace block ~ ~ ~ container.2 with minecraft:rotten_flesh 2
item modify block ~ ~ ~ container.2 pot:ui_frame
item replace block ~ ~ ~ container.3 with air
item replace block ~ ~ ~ container.4 with minecraft:rotten_flesh 2
item modify block ~ ~ ~ container.4 pot:ui_frame
item replace block ~ ~ ~ container.11 with minecraft:cobblestone 1
item modify block ~ ~ ~ container.11 pot:ui_frame
item replace block ~ ~ ~ container.12 with minecraft:rotten_flesh 2
item modify block ~ ~ ~ container.12 pot:ui_frame
item replace block ~ ~ ~ container.13 with minecraft:cobblestone 1
item modify block ~ ~ ~ container.13 pot:ui_frame
item replace block ~ ~ ~ container.20 with minecraft:cobblestone 1
item modify block ~ ~ ~ container.20 pot:ui_frame
item replace block ~ ~ ~ container.21 with minecraft:cobblestone 1
item modify block ~ ~ ~ container.21 pot:ui_frame
item replace block ~ ~ ~ container.22 with minecraft:cobblestone 1
