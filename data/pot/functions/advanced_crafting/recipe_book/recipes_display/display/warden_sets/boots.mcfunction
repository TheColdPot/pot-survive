...
item replace block ~ ~ ~ container.11 with minecraft:diamond 8
item modify block ~ ~ ~ container.11 pot:ui_frame
item replace block ~ ~ ~ container.12 with air
item replace block ~ ~ ~ container.13 with minecraft:diamond 8
...
loot replace block ~ ~ ~ container.21 loot pot:warden_heart
