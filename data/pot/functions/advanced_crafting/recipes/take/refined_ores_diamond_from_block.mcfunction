#> pot:advanced_crafting/recipes/take/refined_ores_diamond_from_block
# TheColdPot <3
data merge entity @s {data:{toCraft:"null"}}
scoreboard players remove @s crafting.slot0 1
...
scoreboard players remove @s crafting.slot2 1
...
scoreboard players remove @s crafting.slot4 1
