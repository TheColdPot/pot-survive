#> pot:advanced_crafting/recipes/take/warden_scepter
# TheColdPot <3
...
scoreboard players remove @s crafting.slot1 16
...
scoreboard players remove @s crafting.slot4 64
...
scoreboard players remove @s crafting.slot7 16
